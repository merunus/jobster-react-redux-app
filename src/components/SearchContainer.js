    ...
    <Wrapper>
      ...
      <form className="form">
        ...
        <div className="form-center">
          ...
          {/* sort  */}
          <FormRowSelect name="sort" value={sort} handleChange={handleSearch} list={["all", ...sortOptions]} />
          <button disabled={isLoading} className="btn btn-block btn-danger" onClick={handleSubmit} >Clear filters</button>
        </div>
      </form>
